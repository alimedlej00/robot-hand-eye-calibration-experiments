"""
Robust UR3a 3-camera validation.
...
PATHS = {
    ...
    "results_dir": ROOT / "3cam_experiment" / "results" / "03_validation_3cam",
    "dh_calibrated": ROOT / "3cam_experiment" / "results" / "02_calibration_3cam" / "dh_calibrated_3cam.json",
    "calibration_report": ROOT / "3cam_experiment" / "results" / "02_calibration_3cam" / "calibration_report_3cam.json",
}
...
def main() -> None:
    ...
    validation = {
        "validation_name": "UR3a_3cam_DH_validation_final",
    ...
    save_json(PATHS["results_dir"] / "validation_report_3cam.json", validation)
    save_csv(PATHS["results_dir"] / "validation_nominal_test_per_pose_3cam.csv", flatten_eval_rows(nominal_test))
    save_csv(PATHS["results_dir"] / "validation_calibrated_test_per_pose_3cam.csv", flatten_eval_rows(calibrated_test))

    print("\n================ 3-CAM VALIDATION SUMMARY ================")
