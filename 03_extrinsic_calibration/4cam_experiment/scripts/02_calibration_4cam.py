"""
Robust UR3a 4-camera DH calibration.
...
PATHS = {
    ...
    "results_dir": ROOT / "4cam_experiment" / "results" / "02_calibration_4cam",
}
...
def main() -> None:
    ...
    save_csv(PATHS["results_dir"] / "accepted_poses_4cam.csv", accepted_rows)
    save_csv(PATHS["results_dir"] / "rejected_poses_4cam.csv", rejected)
    ...
    dh_out = {
        "meta": {
            ...
            "source": "robust_calibrated_from_4cam_triangulation_after_outlier_rejection",
        },
    ...
    save_json(PATHS["results_dir"] / "dh_calibrated_4cam.json", dh_out)
    ...
    report = {
        ...
        "outputs": {
            "dh_calibrated": str(PATHS["results_dir"] / "dh_calibrated_4cam.json"),
            "accepted_poses": str(PATHS["results_dir"] / "accepted_poses_4cam.csv"),
            "rejected_poses": str(PATHS["results_dir"] / "rejected_poses_4cam.csv"),
        },
    }
    save_json(PATHS["results_dir"] / "calibration_report_4cam.json", report)

    print("\n================ 4-CAM CALIBRATION SUMMARY ================")
    ...
    print("\nNext run:")
    print("  python 03_validation_4cam.py")
